...
function Skills(){
  return(
    <div className="w-full h-[80%] bg-slate-50 flex flex-col justify-center items-center rounded-lg m-0">
      <ul className="w-full grid grid-cols-2 md:grid-cols-4 gap-8">
        <li className="flex flex-col justify-center items-center">
          <DiGit  className="text-4xl "/>
          <p className="text-sm ">Git</p>
        </li>
        <li className="flex flex-col justify-center items-center">
          <FaGithub className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">Github</p>
        </li>
        <li className="flex flex-col justify-center items-center">
          <SiJavascript className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">Javascript</p>
        </li>
        <li className="flex flex-col justify-center items-center">
          <FaReact className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">React.js</p>
        </li>
        <li className="flex flex-col justify-center items-center">
          <FaHtml5 className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">HTML5</p>
        </li>
        <li className="flex flex-col justify-center items-center">
          <SiCss3 className="text-4xl text-neutral-800"/>
        ...
        <li className="mx-4 flex flex-col justify-center items-center">
          <SiRedux className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">Redux</p>
        </li>
        <li className="mx-4 flex flex-col justify-center items-center">
          <SiBootstrap className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">Bootstrap</p>
        </li>
        <li className="mx-4 flex flex-col justify-center items-center">
          <SiTailwindcss className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">Tailwind</p>
        </li>
        <li className="mx-4 flex flex-col justify-center items-center">
          <FaDocker className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">Docker</p>
        </li>
        <li className="mx-4 flex flex-col justify-center items-center">
          <GrMysql className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">SQL</p>
        </li>
        <li className="mx-4 flex flex-col justify-center items-center">
          <GrNode className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">Node.js</p>
        </li>
        <li className="mx-4 flex flex-col justify-center items-center">
          <DiHeroku className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">Heroku</p>
        </li>
        <li className="mx-4 flex flex-col justify-center items-center">
          <SiMongodb className="text-4xl text-neutral-800"/>
          <p className="text-sm text-neutral-600">MongoDB</p>
        </li>
        <li className="mx-4 flex flex-col justify-center items-center">
          <SiTypescript className="text-4xl text-neutral-800"/>
