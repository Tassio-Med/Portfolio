...
//   return (
//     <div className="fixed top-0 px-10 left-0 w-full h-full bg-neutral-900 bg-opacity-95 flex items-center justify-center z-[200]">
//       <div id="responsive" className="bg-white p-6 rounded-lg w-full sm:w-[80%] md:w-[60%] lg:w-[40%] flex flex-col text-center">
